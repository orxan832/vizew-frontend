        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="form-group">
                <div className="custom-file">
                    <input type="file" className="custom-file-input" onChange={fileChangeHandler} id="validatedCustomFile" />
                    <label className="custom-file-label" htmlFor="validatedCustomFile">Şəkil seç...</label>
                </div>
            </div>
            <div className='form-group'>
                <Select
